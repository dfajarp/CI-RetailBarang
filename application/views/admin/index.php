...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">(RB) Retail Barang</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i> Beranda</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Supplier<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
    ...
    <script src="<?php base_url()?>assets/vendor/metisMenu/metisMenu.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="<?php base_url()?>assets/vendor/raphael/raphael.min.js"></script>
    <script src="<?php base_url()?>assets/vendor/morrisjs/morris.min.js"></script>
    <script src="<?php base_url()?>assets/data/morris-data.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="<?php base_url()?>assets/dist/js/sb-admin-2.js"></script>
